...
wx.libpannellum = function(E, g, p) {
  function Ba(K) {
      function ja(a, e) {
...
wx.pannellum = function(E, g, p) {
  function Ba(s, k) {
      ...
      function Ba(a) {
          ...
          function() {
              ...
              if (navigator.userAgent.toLowerCase().match(/(iphone|ipod|ipad).* os 8_/)) {
                  var c = n.indexOf("\u00ff\u00c2"); (0 > c || 65536 < c) && K(b.strings.iOS8WebGLError)
              }
      ...
      function a(a) {
          if ("touch" == a.pointerType) {
              for (var b = !1,
              n = 0; n < ia.length; n++) a.pointerId == ia[n] && (ia[n] = p),
              ia[n] && (b = !0);
              b || (ia = [], za = [], Ea());
              a.preventDefault()
          }
      ...
      function ga() {
          if (G) {
              ...
              r[0] && r[1] && (w.hfov = 0); (r[2] || r[6]) && (r[3] || r[7]) && (w.pitch = 0); (r[4] || r[8]) && (r[5] || r[9]) && (w.yaw = 0)
          }
      }
      function m(a) {
          var f = O[a],
      ...
      function Fa() {
          var a;
          if (G) {
              var f = C.getCanvas(); ! 1 !== b.autoRotate && (360 < b.yaw ? b.yaw -= 360 : -360 > b.yaw && (b.yaw += 360));
              a = b.yaw;
              var n = 0;
              ...
              d = -180,
              e = 180;
              360 > c && (d = b.minYaw + b.hfov / 2 + n, e = b.maxYaw - b.hfov / 2 - n, c < b.hfov && (d = e = (d + e) / 2), b.yaw = Math.max(d, Math.min(e, b.yaw))); ! 1 === b.autoRotate && (360 < b.yaw ? b.yaw -= 360 : -360 > b.yaw && (b.yaw += 360)); ! 1 !== b.autoRotate && a != b.yaw && ba !== p && (b.autoRotate *= -1);
      ...
      function va() {
          try {
              ...
              C.init(P, b.type, b.dynamic, b.haov * Math.PI / 180, b.vaov * Math.PI / 180, b.vOffset * Math.PI / 180, S, a); ! 0 !== b.dynamic && (P = p)
          } catch(f) {
      ...
      function La(a) {
          ...
          a.clickHandlerFunc && (f.addEventListener("click",
          function(b) {
      ...
      function ab(a) {
          return a.replace(/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,
          function(a, b) {
              b = b.toLowerCase();
      ...
      v.zoomIn.addEventListener("click",
      function() {
          G && (x(b.hfov - 5), F())
      });
      ...
      v.zoomOut.addEventListener("click",
      function() {
          G && (x(b.hfov + 5), F())
      });
      ...
      v.fullscreen.className = "pnlm-fullscreen-toggle-button pnlm-sprite pnlm-fullscreen-toggle-button-inactive pnlm-controls pnlm-control"; (g.fullscreenEnabled || g.mozFullScreenEnabled || g.webkitFullscreenEnabled || g.msFullscreenEnabled) && v.container.appendChild(v.fullscreen);
      v.orientation = g.createElement("div");
      v.orientation.addEventListener("click",
      function(a) {
          X ? Da() : Ra()
      });
      v.orientation.addEventListener("mousedown",
      function(a) {
          a.stopPropagation()
      });
  ...
  default.firstScene):
      ...
      this.setPitch = function(a, c, d, e) {
          ...
          this; (c = c == p ? 1E3: Number(c)) ? (O.pitch = {
              startTime: Date.now(),
      ...
      this.setHfov = function(a, c, d, e) {
          ...
          this; (c = c == p ? 1E3: Number(c)) ? (O.hfov = {
              startTime: Date.now(),
      ...
      this.loadScene = function(a, b, c, d) { ! 1 !== G && y(a, b, c, d);
          return this
      };
